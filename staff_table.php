				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><img src="photo/staff/<?php echo $d->photo; ?>" alt=""></td>
							<td>
								<a class="btn btn-sm btn-info" href="staff_view.php?view_id=<?php echo $d->id;?>">View</a>
								<a class="btn btn-sm btn-warning" href="staff_edit.php?edit_id=<?php echo $d->id;?>">Edit</a>
