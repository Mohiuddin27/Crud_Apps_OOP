...
<body>
	<?php
      if(isset($_POST['add'])){
		...
		$stu->updatestudent($name, $email, $cell, $uname,$edit_id);
		...
		<div class="card">
			<div class="card-body">
                ...
                <div class="form-group">
					...
					<div class="form-group">
					<img style="width:200px; height:200px;"src="photo/students/<?php echo  $data->photo; ?>"><br>
					<input type="file"lass="form-control" name="photo">
					</div>
